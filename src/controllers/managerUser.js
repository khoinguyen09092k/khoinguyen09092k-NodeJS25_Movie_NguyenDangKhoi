...
const getFullInfoUser = async (req, res) => {
    try {
...
const getListInfoUser = async (req, res) => {
    try {
        let getListInfo = await model.loaiNguoiDung.findAll({});
        sucessCode(res, getListInfo, "Lấy danh sách loại người dùng thành công")
...
//commonjs module
module.exports = {
    getInfoUser, getFullInfoUser, getNameUser, getListInfoUser, addUser, updateUser, deleteUser, getUserDevidePage
}